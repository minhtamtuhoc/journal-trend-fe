  ...
  return (
    <AppLayout>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <KpiCard
          label="Trend Score"
          value={KPIS.trendScore.toFixed(1)}
          delta={`+${KPIS.trendScoreDelta}%`}
          accent
        />
        <KpiCard
          label="Active Keywords"
          value={KPIS.activeKeywords.toLocaleString()}
          hint="Across 12 major journals"
        />
        <KpiCard
          label="Citation Volume"
          value={KPIS.citationVolume.toLocaleString()}
          hint="Growth spike detected"
          delta="+12.4%"
        />
        <KpiCard
          label="Sync Health"
          value={`${KPIS.syncHealth}%`}
          hint="Scopus / CrossRef / IEEE"
        />
      </div>
