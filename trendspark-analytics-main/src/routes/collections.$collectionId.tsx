  ...
  return (
    <AppLayout>
        ...
        action={
          <div className="flex flex-wrap items-center gap-2">
            ...
            <div className="hidden sm:block">
              <UiSelect value={sort} onValueChange={(val) => setSort(val as SortMode)}>
                <SelectTrigger className="h-9 px-3 bg-secondary/30 border-border rounded-lg text-xs font-semibold text-foreground focus:ring-1 focus:ring-brand/40">
                  <div className="flex items-center gap-1.5">
                    <span className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground">Sort:</span>
                    <SelectValue />
                  </div>
                </SelectTrigger>
                <SelectContent className="bg-card border border-border text-foreground rounded-xl shadow-2xl z-50">
                  <SelectItem value="recent" className="cursor-pointer focus:bg-brand/10 focus:text-brand text-xs font-medium py-2">
                    Recently saved
                  </SelectItem>
                  <SelectItem value="newest" className="cursor-pointer focus:bg-brand/10 focus:text-brand text-xs font-medium py-2">
                    Newest papers
                  </SelectItem>
                  <SelectItem value="oldest" className="cursor-pointer focus:bg-brand/10 focus:text-brand text-xs font-medium py-2">
                    Oldest papers
                  </SelectItem>
                </SelectContent>
              </UiSelect>
      ...
      <div className="sm:hidden mb-4">
        <UiSelect value={sort} onValueChange={(val) => setSort(val as SortMode)}>
          <SelectTrigger className="h-10 px-3 w-full bg-secondary/30 border-border rounded-xl text-sm font-semibold text-foreground">
          ...
          <SelectContent className="bg-card border border-border text-foreground rounded-xl shadow-2xl z-50">
            <SelectItem value="recent" className="cursor-pointer focus:bg-brand/10 focus:text-brand text-sm font-medium py-2.5">
              Recently saved
            </SelectItem>
            <SelectItem value="newest" className="cursor-pointer focus:bg-brand/10 focus:text-brand text-sm font-medium py-2.5">
              Newest papers
            </SelectItem>
            <SelectItem value="oldest" className="cursor-pointer focus:bg-brand/10 focus:text-brand text-sm font-medium py-2.5">
              Oldest papers
            </SelectItem>
          </SelectContent>
        </UiSelect>
                ...
                <div className="flex items-start justify-between gap-4">
                  ...
                  <div className="shrink-0 flex items-center gap-2">
                    <button
                      ...
                      className="p-1.5 rounded-md border border-border hover:border-brand/40 hover:text-brand transition-colors text-muted-foreground cursor-pointer"
                    ...
                    <button
                      ...
                      className="p-1.5 rounded-md border border-border hover:border-destructive/40 hover:text-destructive transition-colors cursor-pointer"
