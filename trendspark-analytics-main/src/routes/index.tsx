    ...
    <div className="min-h-screen text-foreground">
      ...
      <nav className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-3">
          <img src="/logo.png?v=3" alt="Helix Analytics" className="logo-brand size-8 rounded-lg object-contain glow-brand border border-border/40 shrink-0 bg-surface-elevated p-1" />
